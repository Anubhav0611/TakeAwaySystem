...
urlpatterns = [
    ...
    path('add_cart_admin(?P<int:pid>)', Add_Cart_admin, name='add_cart_admin'),
    ...
    path('cart_admin', view_cart_admin, name='cart_admin'),
    ...
    path('booking(?P<str:pid>/(?P<abc>[0-9]+))', Booking_order, name="booking"),
    path('booking_admin(?P<str:pid>/(?P<abc>[0-9]+))', Booking_order_admin, name="booking_admin"),
